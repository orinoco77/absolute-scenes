...
function TemplateManager({ template, onTemplateUpdate, onClose }) {
  ...
  Object.keys(BOOK_FONTS).forEach(key => {
    ...
    if (font.category === 'serif') {
      // Only show serif fonts for body text
  ...
  const getFontQualityLabel = quality => {
    switch (quality) {
      case 'premium':
        return 'Premium Book Fonts (Best Quality)';
      case 'high':
        return 'High-Quality Alternatives';
      case 'standard':
        return 'Standard System Fonts';
      default:
        return 'Other Fonts';
    }
  };
        ...
        <div className="modal-content">
          ...
          <div className="form-section">
            ...
            <div className="form-group">
                ...
                {Object.entries(fontsByCategory).map(
                  ([quality, fonts]) =>
                    fonts.length > 0 && (
                      <optgroup
                        key={quality}
                        label={getFontQualityLabel(quality)}
                      >
                        {fonts.map(font => (
              ...
              {/* Font Information */}
              {localTemplate.fontFamily &&
                BOOK_FONTS[
                  Object.keys(BOOK_FONTS).find(
                    key => BOOK_FONTS[key].name === localTemplate.fontFamily
                  )
                ] && (
                  <div
                    style={{
                  ...
                  >
                    {(() => {
                      const fontKey = Object.keys(BOOK_FONTS).find(
                        key => BOOK_FONTS[key].name === localTemplate.fontFamily
                      );
                      ...
                      return (
                        <div>
                          <div>
                            <strong>Description:</strong> {font.description}
                          </div>
                          <div>
                            <strong>Best for:</strong> {font.bestFor.join(', ')}
                          </div>
                          <div>
                            <strong>License:</strong> {licenseInfo.note}
                          </div>
                          {licenseInfo.requiresLicense && (
                            ...
                            >
                              ⚠ This font requires a commercial license for
                              book publishing
                            </div>
                          )}
                        </div>
              ...
              <small>
                Serif fonts are traditional for book bodies and enhance
          ...
          <div className="form-group">
            ...
            >
              ✨ <strong>Smart Sizing:</strong> Headers, page numbers, and
              running headers automatically scale with body text size
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <small>
              Trade Paperback (6"×9") is the most popular size for modern books
            </small>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <small>
                Different margins for odd/even pages to account for spine
                binding
              </small>
            </div>
            <div className="margin-inputs">
              ...
              <div className="form-group">
                <label>
                  {localTemplate.mirrorMargins ? 'Inside (Spine)' : 'Left'}
                </label>
                <input
                  type="number"
                  step="0.25"
                  value={
                    localTemplate.pageMargins.inside ||
                    localTemplate.pageMargins.left ||
                    1.25
                  }
                  onChange={e =>
                    handleMarginChange(
                      localTemplate.mirrorMargins ? 'inside' : 'left',
                      e.target.value
                    )
                  }
                />
              ...
              <div className="form-group">
                <label>
                  {localTemplate.mirrorMargins ? 'Outside (Edge)' : 'Right'}
                </label>
                <input
                  type="number"
                  step="0.25"
                  value={
                    localTemplate.pageMargins.outside ||
                    localTemplate.pageMargins.right ||
                    1
                  }
                  onChange={e =>
                    handleMarginChange(
                      localTemplate.mirrorMargins ? 'outside' : 'right',
                      e.target.value
                    )
                  }
                />
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={e =>
                  handleChapterHeaderChange('style', e.target.value)
                }
              >
            ...
            {localTemplate.chapterHeader.style === 'custom' && (
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={e =>
                    handleChapterHeaderChange('format', e.target.value)
                  }
                  placeholder="e.g., 'Chapter {number} - {title}'"
                />
                <small>
                  Use {'{number}'} for chapter number and {'{title}'} for
                  chapter title
                </small>
              </div>
            )}
            ...
            <div className="form-group">
              ...
              />
              <small>
                This is separate from the auto-scaling running headers and
                markdown headings
              </small>
            </div>
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={e =>
                  handleChapterHeaderChange('fontWeight', e.target.value)
                }
              >
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={e =>
                  handleChapterHeaderChange('alignment', e.target.value)
                }
              >
            ...
            <div className="form-group">
              <label>
                <input
                  ...
                  onChange={e =>
                    handleChapterHeaderChange('pageBreak', e.target.checked)
                  }
                />
            ...
            {localTemplate.chapterHeader.pageBreak && (
              <>
                <div className="form-group">
                  ...
                  />
                  <small>
                    Number of blank lines at the top of each new chapter page
                    (0-10)
                  </small>
                </div>
                ...
                <div className="form-group">
                  <label>
                    <input
                      type="checkbox"
                      checked={
                        localTemplate.chapterHeader.startOnRightPage || false
                      }
                      onChange={e =>
                        handleChapterHeaderChange(
                          'startOnRightPage',
                  ...
                  <small>
                    Forces chapters to begin on odd-numbered pages (traditional
                    book layout)
                  </small>
                </div>
              </>
            ...
            <div className="form-group">
              <label>
                <input
                  ...
                  onChange={e =>
                    handleRunningHeaderChange('enabled', e.target.checked)
                  }
                />
              ...
              <>
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={e =>
                      handleRunningHeaderChange('alignment', e.target.value)
                    }
                  >
                  ...
                  <small>
                    Outside edge means left-aligned on left pages, right-aligned
                    on right pages
                  </small>
                </div>
                ...
                <div className="form-group">
                  ...
                  >
                    <strong>ℹ️ Header Font Size:</strong> Automatically sized at
                    75% of body text (currently{' '}
                    {Math.round(localTemplate.fontSize * 0.75)}pt)
                  </div>
                </div>
                ...
                <div className="form-group">
                  <label>
                    <input
                      type="checkbox"
                      checked={
                        localTemplate.runningHeaders?.skipChapterPages || true
                      }
                      onChange={e =>
                        handleRunningHeaderChange(
                          'skipChapterPages',
                          e.target.checked
                        )
                      }
                  ...
                  <small>
                    Traditional books often omit running headers on pages where
                    chapters begin
                  </small>
                </div>
              </>

...
const CharacterAnalyzer = {
  ...
  NON_NAME_WORDS: new Set([
    ...
    'himself', 'herself', 'itself', 'themselves', 'ourselves', 'yourself', 'yourselves',
    // Articles and determiners
    'the', 'a', 'an', 'this', 'that', 'these', 'those', 'some', 'any', 'many', 'much',
    'few', 'several', 'all', 'both', 'each', 'every', 'either', 'neither',
    // Common conjunctions and prepositions
    'and', 'or', 'but', 'so', 'yet', 'for', 'nor', 'with', 'without', 'to', 'from',
    'in', 'on', 'at', 'by', 'of', 'about', 'under', 'over', 'through', 'between',
    'among', 'during', 'before', 'after', 'since', 'until', 'while', 'where', 'when',
    'if', 'as', 'than', 'like', 'against', 'upon', 'within', 'beneath', 'beside', 'beyond',
    // Time/place words
    'here', 'there', 'now', 'then', 'today', 'tomorrow', 'yesterday', 'never', 'always',
    'sometimes', 'often', 'usually', 'rarely', 'seldom', 'once', 'twice', 'again',
    'still', 'already', 'just', 'only', 'even', 'also', 'too', 'very', 'quite', 'rather',
    // Question words
    ...
    'went', 'came', 'said', 'told', 'asked', 'replied', 'answered', 'looked', 'saw',
    'found', 'made', 'took', 'gave', 'got', 'put', 'turned', 'walked', 'ran',
    'let', 'tell', 'get', 'take', 'give', 'make', 'know', 'think', 'see', 'want',
    'need', 'feel', 'seem', 'become', 'leave', 'keep', 'begin', 'help', 'show',
    'hear', 'play', 'move', 'live', 'bring', 'happen', 'write', 'sit', 'stand',
    ...
    'buy', 'serve', 'die', 'send', 'expect', 'build', 'stay', 'fall', 'cut', 'reach',
    'kill', 'remain', 'suggest', 'raise', 'pass', 'sell', 'decide', 'return', 'explain',
    'hope', 'develop', 'carry', 'break', 'receive', 'agree', 'support', 'hit', 'produce',
    'eat', 'cover', 'catch', 'draw', 'choose', 'join', 'attack', 'argue', 'smile',
    // Story/book structure words
    'chapter', 'scene', 'part', 'book', 'story', 'tale', 'end', 'beginning', 'middle',
    // Common adjectives that get capitalized
    'good', 'bad', 'big', 'small', 'old', 'new', 'young', 'long', 'short', 'high',
    'low', 'hot', 'cold', 'warm', 'cool', 'dark', 'light', 'bright', 'heavy', 'easy',
    'hard', 'soft', 'fast', 'slow', 'quick', 'deep', 'shallow', 'wide', 'narrow',
    'thick', 'thin', 'strong', 'weak', 'clean', 'dirty', 'rich', 'poor', 'full', 'empty',
    'loud', 'quiet', 'beautiful', 'ugly', 'happy', 'sad', 'angry', 'calm', 'wild',
    'free', 'busy', 'ready', 'sure', 'real', 'true', 'false', 'right', 'wrong',
    'early', 'late', 'far', 'near', 'close', 'open', 'closed', 'safe', 'dangerous',
    // Common nouns that might be capitalized
    'people', 'person', 'man', 'woman', 'boy', 'girl', 'child', 'children', 'baby',
    'family', 'mother', 'father', 'sister', 'brother', 'friend', 'house', 'home',
    'room', 'door', 'window', 'table', 'chair', 'bed', 'car', 'road', 'street',
    'city', 'town', 'country', 'world', 'water', 'fire', 'earth', 'air', 'sun',
    'moon', 'star', 'day', 'night', 'morning', 'evening', 'afternoon', 'time',
    'year', 'month', 'week', 'hour', 'minute', 'second', 'moment', 'life', 'death',
    'love', 'hate', 'peace', 'war', 'hope', 'fear', 'joy', 'sadness', 'anger',
    'hand', 'head', 'eye', 'face', 'body', 'heart', 'mind', 'voice', 'word', 'name',
    'place', 'way', 'side', 'back', 'front', 'top', 'bottom', 'kind', 'type', 'sort',
    'part', 'piece', 'bit', 'lot', 'group', 'team', 'company', 'business', 'job', 'work',
    'money', 'power', 'number', 'point', 'line', 'area', 'level', 'order', 'system',
    'government', 'community', 'society', 'public', 'service', 'problem', 'question',
    'answer', 'reason', 'idea', 'fact', 'information', 'news', 'case', 'result',
    'change', 'end', 'start', 'beginning', 'middle', 'example', 'way', 'method',
    ...
    'few', 'many', 'most', 'more', 'less', 'much', 'little', 'enough', 'several',
    // Modal and conditional words
    'don', 'doesn', 'won', 'wouldn', 'can', 'cannot', 'couldn', 'shouldn', 'mustn',
    'aren', 'isn', 'wasn', 'weren', 'haven', 'hasn', 'hadn', 'didn', 'doesn',
    // Fantasy/sci-fi terms that might not be names
    'magic', 'spell', 'sword', 'dragon', 'knight', 'king', 'queen', 'prince',
    'princess', 'lord', 'lady', 'sir', 'master', 'servant', 'guard', 'soldier',
    'captain', 'general', 'emperor', 'empire', 'kingdom', 'castle', 'tower',
    'forest', 'mountain', 'river', 'sea', 'ocean', 'island', 'desert', 'valley',
    'harbour', 'harbor', 'bay', 'coast', 'shore', 'beach', 'cliff', 'hill', 'plain',
    'field', 'meadow', 'wood', 'tree', 'stone', 'rock', 'gold', 'silver', 'iron',
    'steel', 'weapon', 'armor', 'shield', 'bow', 'arrow', 'spear', 'axe', 'hammer',
    'crown', 'throne', 'palace', 'temple', 'church', 'hall', 'chamber', 'dungeon',
    'gate', 'wall', 'bridge', 'road', 'path', 'trail', 'journey', 'quest', 'adventure',
    'battle', 'fight', 'war', 'peace', 'victory', 'defeat', 'army', 'force', 'power',
    'magic', 'spell', 'charm', 'curse', 'blessing', 'gift', 'talent', 'skill', 'art',
    'craft', 'trade', 'merchant', 'trader', 'shop', 'market', 'inn', 'tavern',
    // Additional words that might be capitalized but aren't names
    'true', 'false', 'maybe', 'yes', 'no', 'indeed', 'certainly', 'perhaps',
    'anyway', 'somehow', 'somewhere', 'something', 'someone', 'everyone',
    'everything', 'everywhere', 'anything', 'anyone', 'anywhere', 'nothing',
    'nobody', 'nowhere', 'meanwhile', 'however', 'therefore', 'otherwise',
    'nevertheless', 'furthermore', 'moreover', 'besides', 'instead', 'rather',
    'although', 'though', 'unless', 'because', 'since', 'while', 'whereas',
    'whether', 'either', 'neither', 'both', 'not', 'nor', 'never', 'always',
    'sometimes', 'often', 'usually', 'rarely', 'hardly', 'barely', 'almost',
    'quite', 'rather', 'pretty', 'fairly', 'really', 'truly', 'actually',
    'probably', 'possibly', 'certainly', 'definitely', 'absolutely', 'completely',
    'totally', 'entirely', 'exactly', 'precisely', 'especially', 'particularly',
    'generally', 'usually', 'normally', 'typically', 'basically', 'essentially',
    'mainly', 'mostly', 'largely', 'partly', 'slightly', 'somewhat', 'rather',
    // Common location terms that could be capitalized
    'place', 'places', 'location', 'locations', 'area', 'areas', 'region', 'regions',
    'district', 'districts', 'territory', 'territories', 'zone', 'zones', 'section', 'sections',
    'north', 'south', 'east', 'west', 'northeast', 'northwest', 'southeast', 'southwest',
    'upper', 'lower', 'inner', 'outer', 'central', 'downtown', 'uptown', 'midtown',
    // Common story elements that aren't character names
    'prologue', 'epilogue', 'introduction', 'conclusion', 'appendix', 'index',
    'contents', 'acknowledgments', 'dedication', 'preface', 'afterword',
    // Common greetings and exclamations that get capitalized
    'hello', 'hi', 'hey', 'bye', 'goodbye', 'thanks', 'thank', 'please', 'sorry',
    'excuse', 'pardon', 'wow', 'oh', 'ah', 'um', 'hmm', 'well', 'okay', 'ok',
    'yes', 'yeah', 'yep', 'nope', 'stop', 'wait', 'come', 'go', 'look', 'see',
    'aye', 'nay', 'indeed', 'alas', 'behold', 'hark', 'lo'
  ]),
  ...
  isLikelyName(word) {
    ...
    if (words.length > 1) {
      ...
      const commonStarters = new Set([
        'if', 'as', 'but', 'when', 'where', 'while', 'since', 'because', 'although',
        'though', 'unless', 'until', 'after', 'before', 'during', 'against', 'upon',
        'with', 'without', 'through', 'between', 'among', 'above', 'below', 'under',
        'over', 'beside', 'behind', 'beyond', 'within', 'throughout', 'across',
        'let', 'tell', 'get', 'take', 'give', 'make', 'see', 'look', 'come', 'go',
        'not', 'nor', 'never', 'always', 'sometimes', 'often', 'usually', 'rarely',
        'just', 'only', 'even', 'also', 'too', 'very', 'quite', 'rather', 'still',
        'already', 'again', 'once', 'twice', 'then', 'now', 'here', 'there',
        'are', 'were', 'was', 'been', 'being', 'have', 'has', 'had', 'will', 'would',
        'could', 'should', 'might', 'may', 'can', 'must', 'shall', 'do', 'does', 'did',
      ...
      const titleCombos = new Set([
        'young prince', 'old king', 'fair folk', 'your grace', 'my lord', 'my lady',
        'dear sir', 'good sir', 'poor man', 'old man', 'young man', 'good woman',
        'old woman', 'young woman', 'little girl', 'little boy', 'big man',
        'the king', 'the queen', 'the prince', 'the princess', 'the lord', 'the lady',
        'the captain', 'the general', 'the commander', 'the master', 'the servant',
        'the guard', 'the soldier', 'the knight', 'the wizard', 'the witch',
        'the dragon', 'the beast', 'the monster', 'the demon', 'the angel',
        'the aelfin', 'the folk', 'the people', 'the men', 'the women', 'the children'
      ]);
  ...
  getCharacterPresenceScore(content, name) {
    ...
    matches.forEach(match => {
      ...
      const beforeText = content.substring(Math.max(0, index - 50), index).toLowerCase();
      const afterText = content.substring(index + name.length, Math.min(content.length, index + name.length + 50)).toLowerCase();
      const contextText = (beforeText + ' ' + name.toLowerCase() + ' ' + afterText).toLowerCase();
      
      // HIGH PRESENCE INDICATORS (strongly suggest the character is present)
      
      // Direct dialogue attribution
      if (/\b(said|replied|asked|whispered|shouted|muttered|called|exclaimed|continued|added|interrupted|answered|responded|declared|announced|observed|remarked|noted|commented|stated|mentioned)\b/.test(afterText)) {
        presenceScore += 3;
      }
      
      // Action verbs (character doing something)
      if (/\b(walked|ran|moved|went|came|entered|left|sat|stood|looked|watched|turned|opened|closed|grabbed|took|put|held|dropped|picked|stepped|climbed|jumped|fell|stopped|started|began|finished|continued|paused|waited|listened|heard|saw|noticed|realized|thought|wondered|remembered|forgot|decided|chose|tried|attempted|managed|failed|succeeded|smiled|frowned|nodded|shook|laughed|cried|sighed|breathed|blinked|stared|glanced|pointed|reached|touched|felt|pulled|pushed|lifted|carried|threw|caught)\b/.test(afterText)) {
        presenceScore += 2;
      }
      
      // Possessive indicating immediate presence/action
      if (/['']s\s+(eyes?|hands?|face|head|voice|body|arms?|legs?|fingers?|hair|mouth|lips|smile|frown|expression|gaze|look|nod|shake|breath|sigh|laugh|cry|tear|movement|gesture|reaction|response)\b/.test(afterText)) {
        presenceScore += 2;
      }
      ...
      if (index === 0 || /[.!?]\s*$/.test(beforeText) || /^\s*$/.test(beforeText)) {
        presenceScore += 1;
      }
      ...
      if (/\b(about|regarding|concerning|remember|recalled|mentioned|told me about|heard about|spoke of|thought of|reminded of|story about|tale of)\s+/.test(beforeText)) {
        presenceScore -= 1;
      }
      
      // Character in possessive context that suggests absence
      if (/['']s\s+(letter|message|note|book|story|house|room|belongings|things|stuff|property|work|job|family|parents|children|past|history|memory|dream|idea|plan|thoughts?)\b/.test(afterText)) {
        presenceScore -= 0.5;
      }
      
      // Temporal indicators suggesting past/future
      if (/\b(yesterday|tomorrow|last week|next week|before|after|when he was|when she was|used to|will|would have|had been|years ago|months ago|days ago)\b/.test(contextText)) {
        presenceScore -= 0.5;
      }
    });
  ...
  isLikelyPlaceName(word) {
    ...
    const placeIndicators = [
      ...
      'castle', 'tower', 'fort', 'fortress', 'palace', 'hall', 'manor', 'house', 'keep',
      'temple', 'church', 'cathedral', 'abbey', 'monastery', 'shrine', 'sanctuary',
      'tavern', 'inn', 'pub', 'lodge', 'hostel', 'market', 'square', 'plaza',
      'bridge', 'gate', 'wall', 'arch', 'port', 'harbor', 'harbour', 'dock', 'wharf',
      
      // Settlements
      'city', 'town', 'village', 'hamlet', 'settlement', 'colony', 'outpost',
      'kingdom', 'empire', 'realm', 'domain', 'duchy', 'county', 'shire',
      'province', 'territory', 'region', 'district', 'quarter', 'ward',
      
      // Natural features
      'mountain', 'mountains', 'hill', 'hills', 'peak', 'ridge', 'cliff', 'canyon',
      'valley', 'glen', 'dale', 'hollow', 'gorge', 'pass', 'gap',
      'forest', 'wood', 'woods', 'grove', 'thicket', 'jungle', 'wilderness',
      'river', 'stream', 'creek', 'brook', 'lake', 'pond', 'pool', 'spring',
      'sea', 'ocean', 'bay', 'gulf', 'strait', 'channel', 'sound',
      'island', 'isle', 'archipelago', 'atoll', 'reef',
      'desert', 'waste', 'wasteland', 'badlands', 'moor', 'heath', 'bog', 'marsh',
      'plain', 'plains', 'field', 'fields', 'meadow', 'prairie', 'steppe',
      'coast', 'shore', 'beach', 'strand', 'peninsula', 'cape', 'point',
      
      // Roads & paths
      'road', 'street', 'avenue', 'lane', 'way', 'path', 'trail', 'route',
      'highway', 'byway', 'thoroughfare', 'boulevard', 'drive', 'court',
      
      // Directional/geographic terms when part of place names
      'north', 'south', 'east', 'west', 'northern', 'southern', 'eastern', 'western',
      'upper', 'lower', 'high', 'low', 'great', 'little', 'old', 'new'
    ];
    ...
    const placeSuffixes = [
      'burg', 'burgh', 'berg', 'boro', 'borough',
      'shire', 'ford', 'ham', 'ton', 'ville', 'stad', 'stadt',
      'land', 'lands', 'feld', 'field', 'wick', 'worth', 'by',
      'haven', 'port', 'mouth', 'head', 'end', 'side'
    ];
    ...
    const compassTerms = ['north', 'south', 'east', 'west', 'northeast', 'northwest', 'southeast', 'southwest'];
  ...
  deduplicateCharacters(characterPresence) {
    ...
    const titles = ['prince', 'king', 'queen', 'princess', 'lord', 'lady', 'sir', 'captain', 
                   'commander', 'general', 'master', 'doctor', 'dr', 'mr', 'mrs', 'miss', 'ms',
                   'duke', 'duchess', 'earl', 'baron', 'count', 'knight', 'dame', 'major',
                   'colonel', 'admiral', 'sergeant', 'lieutenant', 'corporal', 'private',
                   'professor', 'father', 'mother', 'brother', 'sister', 'elder', 'young',
                   'old', 'saint', 'elder', 'thane', 'archduke', 'magistrate', 'chancellor'];
    ...
    for (let i = 0; i < entries.length; i++) {
      ...
      for (let j = i + 1; j < entries.length; j++) {
        ...
        if (lowerA.includes(lowerB) && lowerA !== lowerB) {
          ...
          else if (wordsA.length === 2 && wordsB.length === 1 && 
                   wordsA[1] === wordsB[0]) {
          ...
          else if (wordsB.length === 2 && wordsA.length === 1 && 
                   wordsB[0] === wordsA[0]) {
        ...
        // e.g., "Galen" and "Galen Hardwine" should merge to "Galen Hardwine"
          ...
          if (wordsA.length === 1 && wordsB.length > 1 && wordsB.includes(wordsA[0])) {
            keepName = nameB; // Keep the longer name
            removeName = nameA;
            keepData = dataB;
            removeData = dataA;
          } else if (wordsB.length === 1 && wordsA.length > 1 && wordsA.includes(wordsB[0])) {
  ...
  extractCharacterNames(content, userBlacklist = [], filterMentions = true, threshold = 2.0) {
    if (!content) return [];
    
    const names = new Set();
    
    // Create combined blacklist for this extraction
    const combinedBlacklist = new Set([...this.NON_NAME_WORDS, ...userBlacklist.map(name => name.toLowerCase())]);
    ...
    const dialoguePattern = /([A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\s+(?:said|replied|asked|whispered|shouted|muttered|called|exclaimed|continued|added|interrupted|nodded|smiled|laughed|sighed|frowned|shrugged|answered|responded|declared|announced|observed|remarked|noted|commented|stated|mentioned)(?:[.,!?]|\s|$)/gi;
    const dialogueMatches = content.match(dialoguePattern);
    if (dialogueMatches) {
      dialogueMatches.forEach(match => {
        const name = match.replace(/\s+(?:said|replied|asked|whispered|shouted|muttered|called|exclaimed|continued|added|interrupted|nodded|smiled|laughed|sighed|frowned|shrugged|answered|responded|declared|announced|observed|remarked|noted|commented|stated|mentioned)(?:[.,!?]|\s|$).*/gi, '').trim();
        if (this.isLikelyName(name) && 
          ...
          potentialCharacters.set(name, (potentialCharacters.get(name) || 0) + score);
        }
      });
    }
    
    // Method 2: Look for quoted dialogue followed by names
    const quotedDialoguePattern = /"[^"]*",?\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\s+(?:said|replied|asked|whispered|shouted|muttered|called|exclaimed|answered|responded|declared|announced|observed|remarked|noted|commented|stated|mentioned)(?:[.,!?]|\s|$)/gi;
    const quotedMatches = content.match(quotedDialoguePattern);
    if (quotedMatches) {
      quotedMatches.forEach(match => {
        const nameMatch = match.match(/",?\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\s+(?:said|replied|asked|whispered|shouted|muttered|called|exclaimed|answered|responded|declared|announced|observed|remarked|noted|commented|stated|mentioned)(?:[.,!?]|\s|$)/i);
    ...
    if (capitalizedWords) {
      ...
      Object.entries(wordCounts).forEach(([word, count]) => {
        if (count >= 2) { // Lowered from 3 since we'll filter by presence anyway
          const score = this.getCharacterPresenceScore(content, word);
          potentialCharacters.set(word, (potentialCharacters.get(word) || 0) + score);
        }
      });
    }
    ...
    if (actionMatches) {
      actionMatches.forEach(match => {
        const name = match.replace(/\s+(?:walked|ran|moved|went|came|entered|left|sat|stood|looked|watched|turned|opened|closed|grabbed|took|put|held|dropped|picked|called|shouted|whispered|smiled|frowned|nodded|shook|stepped|climbed|jumped|fell|stopped|started|began|finished|continued|paused|waited|listened|heard|saw|noticed|realized|thought|wondered|remembered|forgot|decided|chose|tried|attempted|managed|failed|succeeded).*/gi, '').trim();
        if (this.isLikelyName(name) && 
            !combinedBlacklist.has(name.toLowerCase()) &&
            !this.isLikelyPlaceName(name)) {
          const score = this.getCharacterPresenceScore(content, name);
  ...
  analyzeCharacterPresence(chapters, formalCharacters = [], userBlacklist = [], filterMentions = true, threshold = 2.0) {
    ...
    chapters.forEach((chapter, chapterIndex) => {
      chapter.scenes.forEach((scene, sceneIndex) => {
        ...
        const detectedNames = this.extractCharacterNames(scene.content, userBlacklist, filterMentions, threshold);
    ...
    return { characterPresence, allDetectedCharacters: Array.from(characterPresence.keys()) };
  }
};

function CharacterThreadVisualization({ chapters, characters, characterDetectionBlacklist = [], onUpdateCharacterDetectionBlacklist }) {
  const [selectedCharacters, setSelectedCharacters] = useState(new Set());
  const [hoveredCharacter, setHoveredCharacter] = useState(null);
  const [showOnlySelected, setShowOnlySelected] = useState(false);
  const [excludedCharacters, setExcludedCharacters] = useState(new Set(characterDetectionBlacklist));
  ...
  const analysis = useMemo(() => {
    return CharacterAnalyzer.analyzeCharacterPresence(chapters, characters, characterDetectionBlacklist, filterMentions, presenceThreshold);
  }, [chapters, characters, characterDetectionBlacklist, filterMentions, presenceThreshold]);
  
  const { characterPresence, allDetectedCharacters } = analysis;
  ...
  const visibleCharacters = useMemo(() => {
    ...
    return chars;
  }, [characterPresence, selectedCharacters, showOnlySelected, excludedCharacters, showExcluded]);
  
  // Generate colors for characters
  const characterColors = useMemo(() => {
    const colors = [
      '#2563eb', '#dc2626', '#059669', '#7c3aed', '#ea580c',
      '#0891b2', '#c2410c', '#9333ea', '#0d9488', '#b91c1c',
      '#4338ca', '#16a34a', '#ca8a04', '#be185d', '#0369a1'
    ];
  ...
  const actualScenesWidth = allScenes.length > 1 ? 
    (allScenes.length - 1) * Math.max(minSceneSpacing, Math.min(maxSceneSpacing, 50)) + leftMargin + rightMargin + 20 :
  ...
  const baseHeight = Math.min(600, Math.max(400, visibleCharacters.length * 30 + 120)); 
  ...
  const calculatedSpacing = allScenes.length > 1 ? Math.min(maxSceneSpacing, plotWidth / Math.max(allScenes.length - 1, 1)) : plotWidth / 2;
  const sceneSpacing = Math.max(minSceneSpacing, calculatedSpacing);
  
  const characterSpacing = visibleCharacters.length > 1 ? plotHeight / (visibleCharacters.length - 1) : plotHeight / 2;
  ...
  if (visibleCharacters.length === 0) {
    return (
      <div className="character-threads" style={{ 
        padding: '2rem', 
        textAlign: 'center',
        height: '100%',
        maxHeight: '800px',
        ...
        <div style={{ 
          ...
          <p style={{ margin: '0 0 1rem 0', fontSize: '1.1em', color: '#374151' }}>
            No characters detected yet.
          </p>
          <div style={{ fontSize: '0.9em', color: '#6b7280', textAlign: 'left' }}>
            <p><strong>To get character detection working:</strong></p>
            <ul style={{ margin: '0.5rem 0', paddingLeft: '1.5rem' }}>
              <li><strong>Add characters to your character list</strong> - they'll appear here immediately</li>
              <li><strong>Write character dialogue:</strong> "Hello," John said.</li>
              <li><strong>Write character actions:</strong> Dave walked in, Sarah looked around</li>
              <li><strong>Use possessive forms:</strong> Mary's house, Tom's idea</li>
              <li><strong>Names mentioned 3+ times</strong> in a scene are auto-detected</li>
            </ul>
            <p style={{ marginTop: '1rem', fontSize: '0.8em', fontStyle: 'italic' }}>
              💡 The system automatically excludes locations like "London" or "Castle Rock"
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="character-threads" style={{ 
      ...
      <h3 style={{ margin: '0 0 1rem 0', flexShrink: 0 }}>Character Thread Analysis</h3>
      ...
      <div style={{ 
        ...
        {excludedCharacters.size > 0 && (
          ...
          >
            {showExcluded ? `Hide Excluded (${excludedCharacters.size})` : `Show Excluded (${excludedCharacters.size})`}
          </button>
        )}
      ...
      <div style={{ 
        ...
        <svg width={width} height={height} style={{ display: 'block' }}>
          ...
          {visibleCharacters.map(([characterName, data], charIndex) => {
            ...
            const opacity = (selectedCharacters.size === 0 || isSelected) ? 1 : 0.3;
            const strokeWidth = isSelected || isHovered ? 3 : Math.max(1, Math.min(4, data.scenes.size));
          ...
          {visibleCharacters.map(([characterName, data], charIndex) => {
            ...
            const opacity = (selectedCharacters.size === 0 || isSelected) ? 1 : 0.6;
            ...
            return (
              <g key={`${characterName}-label`}>
                <text
                  ...
                  fill={color}
                  opacity={opacity}
                  fontWeight={isSelected || isHovered ? 'bold' : isFromList ? '600' : 'normal'}
                  style={{ cursor: 'pointer' }}
          ...
          {allScenes.map((scene, index) => {
            ...
            return (
              <g key={`scene-label-${scene.key}`}>
                ...
                {(index === 0 || allScenes[index - 1].chapter !== scene.chapter) && (
                  <text
                    x={x}
                    y={topMargin - 35}
                    textAnchor="middle"
      ...
      <div style={{ 
        ...
        <p style={{ margin: 0 }}>
          ...
          Thread thickness shows appearance frequency. 
          Hover for scene details. 
          Use ✕ to permanently exclude false positives.
          {filterMentions && ' Filtering enabled to show only active scene participants.'}
        </p>
        <p style={{ margin: '0.5rem 0 0 0', fontSize: '0.8em' }}>
          <strong>Stats:</strong> {visibleCharacters.length} characters, {allScenes.length} scenes
          {allScenes.length > 10 && ' • Compact layout optimized for long books'}

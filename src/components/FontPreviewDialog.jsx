...
function FontPreviewDialog({
  ...
  useEffect(() => {
    if (currentFont) {
      const metrics = calculateReadingComfort(
        currentFont,
        fontSize,
        lineHeight
      );
...
"We should be careful," Marcus warned, his hand instinctively moving to the hilt of his sword. "The legends speak of guardians in these woods."`
  ...
  return (
    <div className="modal-overlay">
      <div
        className="modal"
        style={{ maxWidth: '900px', width: '90vw', maxHeight: '80vh' }}
      >
        ...
        >
                ...
                {Object.values(BOOK_FONTS)
                  ...
                  .map(font => (
                    <button
                      ...
                      style={{
                        padding: '8px',
                        border: selectedFonts.includes(font.name)
                          ? '2px solid #2196f3'
                          : '1px solid #ddd',
                        backgroundColor: selectedFonts.includes(font.name)
                          ? '#e3f2fd'
                          : 'white',
                        borderRadius: '4px',
                        cursor: 'pointer',
          ...
          <div className="font-previews">
            {fontComparison.map((fontData, _index) => {
                  ...
                  >
                    <div>
                      ...
                      {fontData.info && (
                        ...
                        >
                          Quality: {fontData.info.quality} •{' '}
                          {fontData.info.description}
                        </div>
                      )}
                    </div>
                    ...
                    {previewText === 'mixed' ? (
                      <div>
                        ...
                        <p>
                          ...
                          <em>ancient oak trees</em>, casting dappled shadows
                          across the forest floor. Sarah knew she was close
                          now—the pull of the mysterious artifact grew stronger
                          with each step.
                        </p>
                        <p>
                          "We should be careful," Marcus warned, his hand
                          instinctively moving to the hilt of his sword. "The
                          legends speak of guardians in these woods."
                        </p>
                      </div>
                    ) : previewText === 'title' ? (
                      <div

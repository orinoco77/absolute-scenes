...
**Version:** <!--VERSION-->1.4.54<!--/VERSION--> | **Tests:** <!--TESTS-->1155/1155<!--/TESTS--> ✅
...
**Code Quality:** <!--TESTS-->1155/1155<!--/TESTS--> tests passing ✅ | **Total Commits:**

<!--COMMITS-->195<!--/COMMITS--> | **Latest:** <!--COMMIT-->3de923e - fix: make sync triggers await and fail silently, clear stale conflict ids (7 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.54<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.54<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-08-30<!--/DATE--> | Build <!--COMMIT-->3de923e - fix: make sync triggers await and fail silently, clear stale conflict ids (7 minutes ago)<!--/COMMIT-->_

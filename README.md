...
**Version:** <!--VERSION-->1.4.51<!--/VERSION--> | **Tests:** <!--TESTS-->1150/1150<!--/TESTS--> ✅
...
**Code Quality:** <!--TESTS-->1150/1150<!--/TESTS--> tests passing ✅ | **Total Commits:**

<!--COMMITS-->192<!--/COMMITS--> | **Latest:** <!--COMMIT-->cc833e7 - feat: add sidecar sync-cache file (IPC channel + renderer adapter) (11 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.51<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.51<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-08-30<!--/DATE--> | Build <!--COMMIT-->cc833e7 - feat: add sidecar sync-cache file (IPC channel + renderer adapter) (11 minutes ago)<!--/COMMIT-->_

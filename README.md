...
**Version:** <!--VERSION-->1.4.76<!--/VERSION--> | **Tests:** <!--TESTS-->1136/1136<!--/TESTS--> ✅
| **Last Updated:** <!--DATE-->2026-09-01<!--/DATE-->
...
<!--COMMITS-->218<!--/COMMITS--> | **Latest:** <!--COMMIT-->38732c6 - fix: set BrowserWindow icon explicitly for Linux taskbar/window-list (12 hours ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.76<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.76<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-09-01<!--/DATE--> | Build <!--COMMIT-->38732c6 - fix: set BrowserWindow icon explicitly for Linux taskbar/window-list (12 hours ago)<!--/COMMIT-->_

...
**Version:** <!--VERSION-->1.4.64<!--/VERSION--> | **Tests:** <!--TESTS-->1134/1134<!--/TESTS--> ✅
...
<!--COMMITS-->205<!--/COMMITS--> | **Latest:** <!--COMMIT-->6275021 - fix: performGitSync read a stale closure over book, silently deleting scenes (5 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.64<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.64<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-08-31<!--/DATE--> | Build <!--COMMIT-->6275021 - fix: performGitSync read a stale closure over book, silently deleting scenes (5 minutes ago)<!--/COMMIT-->_

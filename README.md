...
**Version:** <!--VERSION-->1.4.45<!--/VERSION--> | **Tests:** <!--TESTS-->1139/1139<!--/TESTS--> ✅
...
<!--COMMITS-->184<!--/COMMITS--> | **Latest:** <!--COMMIT-->bb358d2 - Bump jws from 3.2.2 to 3.2.3 (12 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.45<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.45<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-03-22<!--/DATE--> | Build <!--COMMIT-->bb358d2 - Bump jws from 3.2.2 to 3.2.3 (12 minutes ago)<!--/COMMIT-->_

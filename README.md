...
**Version:** <!--VERSION-->1.4.70<!--/VERSION--> | **Tests:** <!--TESTS-->1144/1144<!--/TESTS--> ✅
...
<!--COMMITS-->212<!--/COMMITS--> | **Latest:** <!--COMMIT-->0393efe - fix: build Windows unsigned when no cert is configured (9 minutes ago)<!--/COMMIT-->
...
_Last updated <!--DATE-->2026-08-31<!--/DATE--> | Build <!--COMMIT-->0393efe - fix: build Windows unsigned when no cert is configured (9 minutes ago)<!--/COMMIT-->_

...
**Version:** <!--VERSION-->1.3.96<!--/VERSION--> | **Tests:** <!--TESTS-->1048/1048<!--/TESTS--> ✅
...
<!--COMMITS-->113<!--/COMMITS--> | **Latest:** <!--COMMIT-->4eb641f - Dark mode fixes (24 hours ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.3.96<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.3.96<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2025-09-15<!--/DATE--> | Build <!--COMMIT-->4eb641f - Dark mode fixes (24 hours ago)<!--/COMMIT-->_

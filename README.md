...
**Version:** <!--VERSION-->1.4.55<!--/VERSION--> | **Tests:** <!--TESTS-->1124/1124<!--/TESTS--> ✅
...
**Code Quality:** <!--TESTS-->1124/1124<!--/TESTS--> tests passing ✅ | **Total Commits:**

<!--COMMITS-->196<!--/COMMITS--> | **Latest:** <!--COMMIT-->cd9e884 - feat: show a conflict badge in the scene list for scenes needing attention (12 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.55<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.55<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-08-30<!--/DATE--> | Build <!--COMMIT-->cd9e884 - feat: show a conflict badge in the scene list for scenes needing attention (12 minutes ago)<!--/COMMIT-->_

...
**Version:** <!--VERSION-->1.4.75<!--/VERSION--> | **Tests:** <!--TESTS-->0/48<!--/TESTS--> ✅
...
**Code Quality:** <!--TESTS-->0/48<!--/TESTS--> tests passing ✅ | **Total Commits:**

<!--COMMITS-->217<!--/COMMITS--> | **Latest:** <!--COMMIT-->3f20d55 - fix: clear the hardcoded signtoolOptions default when no cert is provided (61 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.75<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.75<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-08-31<!--/DATE--> | Build <!--COMMIT-->3f20d55 - fix: clear the hardcoded signtoolOptions default when no cert is provided (61 minutes ago)<!--/COMMIT-->_

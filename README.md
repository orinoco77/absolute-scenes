...
**Version:** <!--VERSION-->1.3.111<!--/VERSION--> | **Tests:** <!--TESTS-->1064/1064<!--/TESTS--> ✅
...
<!--COMMITS-->134<!--/COMMITS--> | **Latest:** <!--COMMIT-->c38778e - Fixes for epub and html exporters (12 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.3.111<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.3.111<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2025-09-25<!--/DATE--> | Build <!--COMMIT-->c38778e - Fixes for epub and html exporters (12 minutes ago)<!--/COMMIT-->_

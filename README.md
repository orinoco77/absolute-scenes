...
**Version:** <!--VERSION-->1.4.78<!--/VERSION--> | **Tests:** <!--TESTS-->1136/1136<!--/TESTS--> ✅
...
<!--COMMITS-->221<!--/COMMITS--> | **Latest:** <!--COMMIT-->30e0724 - fix: convert manualChunks to a function for rolldown compatibility (13 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.78<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.78<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2026-09-03<!--/DATE--> | Build <!--COMMIT-->30e0724 - fix: convert manualChunks to a function for rolldown compatibility (13 minutes ago)<!--/COMMIT-->_

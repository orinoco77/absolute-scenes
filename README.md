...
**Version:** <!--VERSION-->1.4.7<!--/VERSION--> | **Tests:** <!--TESTS-->1064/1064<!--/TESTS--> ✅
...
<!--COMMITS-->142<!--/COMMITS--> | **Latest:** <!--COMMIT-->30daa65 - Fix Chocolatey package validation issues (46 minutes ago)<!--/COMMIT-->
...
**Current Release: v<!--VERSION-->1.4.7<!--/VERSION-->** - See [Version History](#version-history)
below for recent updates. **Current Release: v<!--VERSION-->1.4.7<!--/VERSION-->** - See
...
_Last updated <!--DATE-->2025-09-26<!--/DATE--> | Build <!--COMMIT-->30daa65 - Fix Chocolatey package validation issues (46 minutes ago)<!--/COMMIT-->_
